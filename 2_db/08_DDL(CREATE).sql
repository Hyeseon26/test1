...
-- ORA-01400: NULL을 ("JHS"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(JHS.USER_ID_U)에 위배됩니다
                        --> UNIQUE
...
-- ORA-00001: 무결성 제약 조건(JHS.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(JHS.USER_NO_PK)에 위배됩니다 == UNIQUE 오류와 같음


INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '박철수', '남', '010-4567-1244', 'park123@kh.or.kr');
--> 기본키가 NULL이므로 오류
-- ORA-01400: NULL을 ("JHS"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다 == NOT NULL 오류와 같음
...
-- 회원 번호와 아이디 둘다 중복 되었을 때만 제약ㅈ건 위배 에러 발생
-- ORA-00001: 무결성 제약 조건(JHS.PK_USERNO_USERID)에 위배됩니다
...
-- 참조할 테이브르이 참조할 컬럼명이 생략이 되면, PRIMARY KEY로 설정된 컬럼이 자동 참조할 컬럼이 됨
...
-- ORA-02291: 무결성 제약조건(JHS.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
            --> 참조 무결성 위배
...
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(JHS.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(JHS.GENDER_CHECK)이 위배되었습니다
