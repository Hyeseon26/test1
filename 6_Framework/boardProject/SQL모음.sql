...
IMG_PATH = '/resources/images/board/';
COMMIT;

-- 게시글 샘플 이미지
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00001.jpg', 'cat1.jpg', 0, 1495);
    
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00002.jpg', 'cat2.jpg', 0, 1494);
    
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00003.jpg', 'cat3.jpg', 0, 1490);
    
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00004.jpg', 'cat4.jpg', 0, 1481);
    
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00005.jpg', 'cat5.jpg', 0, 1479);
...
SELECT COUNT(*) 
FROM BOARD_LIKE L
WHERE L.BOARD_NO = 1494;


-- 특정 게시글에 대한 댓글 목록 조회(바꿀예정)
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1', DEFAULT, DEFAULT, 1508, 1, 1006);
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00002.jpg', 'cat2.jpg', 2, 1495);
COMMIT;
    
-- 회원 프로필 이미지 변경
UPDATE MEMBER SET
PROFILE_IMG = '/resources/images/member/고라파덕.gif'
WHERE MEMBER_NO = 1;
